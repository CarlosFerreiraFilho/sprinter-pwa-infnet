...
const Navbar = () => {
  ...
  return (
    <nav className="background-primary text-white p-4">
      <div className="container mx-auto flex justify-between items-center">
        {/* Logo ou Nome do App */}
        <div className="text-2xl font-bold">
          <Link href="/home">Sprinter</Link>
        </div>
        ...
        <div className="md:hidden mt-2 space-y-2">
          {user && (
            <>
              ...
              <Link href="/profile" onClick={closeMenu} className="block px-2 py-1 hover:bg-blue-400">Perfil</Link>
            </>
          )}
          {user ? (
            <button
